...
public class DemoController : MonoBehaviour {
	...
	void UpdateColor(){
		...
		cur_effect.transform.FindChild("Light").GetComponent<Light>().color = new Color(light_col.r,light_col.g-levelOfRed/4f,light_col.b);
	...
	void Init(){
		...
		light_col = cur_effect.transform.FindChild("Light").GetComponent<Light>().color;
		UpdateColor();
	}
